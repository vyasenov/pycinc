...
def generate_data(n_control=500, n_treatment=500, treatment_effect=2.0):
    """Generate synthetic data for CiC estimation."""
    # Control group
...
def main():
    print("Basic Changes-in-Changes Estimation")
    print("=" * 40)
    
    # Generate data
    data = generate_data(n_control=500, n_treatment=500, treatment_effect=2.0)
